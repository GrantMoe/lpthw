...
it in the bridge, and blow the ship up after getting into an esxcap pod.
...
laughing you run ip and shoot him square in the head putting him down,
...
pod before the whole ship explodes.  It seems like hardly any Fothons
are on the ship, so your run is clear of interference.  You get to the
chmaber with the escape pods, and now need to pick one to take.  Some of
them cound be damaged but you don't have time to look.  There's 5 pods,
